...
update tournament_participants set role = 'adjudicator' where tournament_id = 1 and role = 'ca';
update tournament_participants set role = 'ca' where tournament_id = 1 and speaker_id = 90 or speaker_id = 7 or speaker_id = 91;
INSERT INTO achievements (tournament_id, speaker_id, type, name) VALUES (1, 92, 'adjudicator', 'лучший судья');
INSERT INTO achievements (tournament_id, speaker_id, type, name) VALUES (1, 93, 'adjudicator', 'лучший судья');
INSERT INTO achievements (tournament_id, speaker_id, type, name) VALUES (1, 94, 'adjudicator', 'лучший судья');